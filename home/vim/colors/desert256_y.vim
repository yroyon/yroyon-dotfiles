...
""" yroyon
""" Don't force a black background, that's my term's job, thankyouverymuch
"    call <SID>X("Normal", "cccccc", "ffffff", "")
...
""" yroyon
""" Don't fill EOF (bottom lines with ~) with black bg
"""   + darken fg color
"    call <SID>X("NonText", "addbe7", "000000", "bold")
    call <SID>X("NonText", "9dcbd7", "", "bold")
