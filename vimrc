...
" Invoke sudo to write into open file
...
" Disable conceal mode for Haskell (see ~/.vim/after/syntax/haskell.vim taken
" from https://github.com/Twinside/vim-haskellConceal )
